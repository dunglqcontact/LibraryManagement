...
public class OrderController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String getDate = (String) session.getAttribute("GET_DATE");
            ...
            OrderDTO order = new OrderDTO(getDate, returnDate, status);
            OrderDAO orderDAO = new OrderDAO();
            orderDAO.addOrder(order.getOrderID(), userID, getDate, returnDate, status, orderDetails);
            orderDetails = null;
